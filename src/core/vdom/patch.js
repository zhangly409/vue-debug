...
export function createPatchFunction (backend) {
  ...
  // nodeOps 包含操作浏览器原生api,例如createElement、createComment、createTextNode等
  ...
  function removeNode (el) {
    ...
    if (isDef(parent)) {
      console.log('remove node', parent, el)
  ...
  function createElm (
    ...
    console.log('创建真实的节点并插入到dom里',vnode)
    ...
    if (isDef(tag)) {
      ...
      // console.log('insert text', parentElm, vnode.elm, refElm)
      insert(parentElm, vnode.elm, refElm)
    }
  }
